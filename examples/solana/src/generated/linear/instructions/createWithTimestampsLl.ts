...
export const CREATE_WITH_TIMESTAMPS_LL_DISCRIMINATOR = new Uint8Array([
  150, 165, 147, 28, 68, 41, 48, 41,
]);

export function getCreateWithTimestampsLlDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CREATE_WITH_TIMESTAMPS_LL_DISCRIMINATOR
  );
}

export type CreateWithTimestampsLlInstruction<
...
export type CreateWithTimestampsLlInstructionData = {
...
export type CreateWithTimestampsLlInstructionDataArgs = {
  salt: number | bigint;
...
export function getCreateWithTimestampsLlInstructionDataEncoder(): FixedSizeEncoder<CreateWithTimestampsLlInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CREATE_WITH_TIMESTAMPS_LL_DISCRIMINATOR,
    })
  );
}

export function getCreateWithTimestampsLlInstructionDataDecoder(): FixedSizeDecoder<CreateWithTimestampsLlInstructionData> {
...
export function getCreateWithTimestampsLlInstructionDataCodec(): FixedSizeCodec<
  CreateWithTimestampsLlInstructionDataArgs,
  CreateWithTimestampsLlInstructionData
> {
  return combineCodec(
    getCreateWithTimestampsLlInstructionDataEncoder(),
    getCreateWithTimestampsLlInstructionDataDecoder()
  );
}

export type CreateWithTimestampsLlAsyncInput<
...
> = {
  ...
  salt: CreateWithTimestampsLlInstructionDataArgs['salt'];
  depositAmount: CreateWithTimestampsLlInstructionDataArgs['depositAmount'];
  startTime: CreateWithTimestampsLlInstructionDataArgs['startTime'];
  cliffTime: CreateWithTimestampsLlInstructionDataArgs['cliffTime'];
  endTime: CreateWithTimestampsLlInstructionDataArgs['endTime'];
  startUnlockAmount: CreateWithTimestampsLlInstructionDataArgs['startUnlockAmount'];
  cliffUnlockAmount: CreateWithTimestampsLlInstructionDataArgs['cliffUnlockAmount'];
  isCancelable: CreateWithTimestampsLlInstructionDataArgs['isCancelable'];
};

export async function getCreateWithTimestampsLlInstructionAsync<
  TAccountCreator extends string,
  TAccountCreatorAta extends string,
  TAccountRecipient extends string,
  TAccountSender extends string,
...
>(
  input: CreateWithTimestampsLlAsyncInput<
    TAccountCreator,
    TAccountCreatorAta,
    TAccountRecipient,
    TAccountSender,
  ...
  CreateWithTimestampsLlInstruction<
    TProgramAddress,
    TAccountCreator,
    TAccountCreatorAta,
    TAccountRecipient,
...
> {
  ...
  return Object.freeze({
    ...
    data: getCreateWithTimestampsLlInstructionDataEncoder().encode(
      args as CreateWithTimestampsLlInstructionDataArgs
    ),
    programAddress,
  } as CreateWithTimestampsLlInstruction<
    TProgramAddress,
    TAccountCreator,
    TAccountCreatorAta,
    TAccountRecipient,
...
export type CreateWithTimestampsLlInput<
  TAccountCreator extends string = string,
  TAccountCreatorAta extends string = string,
  TAccountRecipient extends string = string,
  TAccountSender extends string = string,
...
export function getCreateWithTimestampsLlInstruction<
  TAccountCreator extends string,
  TAccountCreatorAta extends string,
  TAccountRecipient extends string,
  TAccountSender extends string,
  ...
  TProgramAddress extends Address = typeof SABLIER_LOCKUP_PROGRAM_ADDRESS,
>(
  input: CreateWithTimestampsLlInput<
    TAccountCreator,
    TAccountCreatorAta,
    TAccountRecipient,
    TAccountSender,
...
export type ParsedCreateWithTimestampsLlInstruction<
  TProgram extends string = typeof SABLIER_LOCKUP_PROGRAM_ADDRESS,
...
export function parseCreateWithTimestampsLlInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedCreateWithTimestampsLlInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getCreateWithTimestampsLlInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
